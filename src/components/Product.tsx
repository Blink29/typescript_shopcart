...
import { ProductType } from "../context/ProdectProvider"
...
function areProductsEqual({product: prevProduct, inCart: prevInCart}: PropTypes, {product: nextProduct, inCart: nextInCart}: PropTypes){
    return (
